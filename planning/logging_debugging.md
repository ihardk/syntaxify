...
> How developers debug Forge generated code and trace issues.
...
[INFO] ✓ Generated 1 component in 0.3s
```
...
Forge emits custom timeline events visible in Flutter DevTools:
...
$ forge inspect button --theme=neo
...
| "Cannot find component" | Missing generation | Run `forge build` |
