...
| Command | Description |
|---------|-------------|
| `meta_gen build` | Generate all components |
| `meta_gen build --theme=neo` | Generate for specific theme |
| `meta_gen build --component=button` | Generate single component |
| `meta_gen watch` | Watch mode, regenerate on change |
| `meta_gen clean` | Remove all generated files |
| `meta_gen list` | List all defined components |
| `meta_gen inspect <name>` | Show component details |
| `meta_gen migrate` | Run schema migrations |
| `meta_gen doctor` | Check system health |
