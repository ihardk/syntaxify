...
| Command                         | Description                     |
| ------------------------------- | ------------------------------- |
| `syntax build`                  | Generate from all AST files     |
| `syntax build --target=flutter` | Generate for specific target    |
| `syntax validate`               | Validate AST without generating |
| `syntax clean`                  | Remove all generated files      |
| `syntax list`                   | List all defined screens        |
