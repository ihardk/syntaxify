...
Define all AST nodes for the Syntaxify UI compiler, covering layout nodes, primitive component nodes, and the screen root. This specification establishes the complete node vocabulary that Syntaxify will support for cross-platform code generation.
...
As a Syntaxify user, I want a complete set of AST nodes, so that I can describe any standard UI layout.
