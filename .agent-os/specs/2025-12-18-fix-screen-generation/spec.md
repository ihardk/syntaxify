...
Refine the `ScreenGenerator` and associated architecture to robustly support `P0` screen definitions, ensuring correct parsing of all properties and emitting properly linked Forge Design System components.
