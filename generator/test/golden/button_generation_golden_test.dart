...
void main() {
  group('Button Generation Golden Tests', () {
    ...
    test('generates expected code for button with all standard properties', () {
      ...
      expect(code, contains('final bool? isLoading'));
      expect(code, contains('final bool? isDisabled'));
    ...
    test('generates expected header comments', () {
      ...
      expect(code, contains('// GENERATED BY SYNTAXIFY'));
      expect(code, contains('// DO NOT MODIFY'));
      expect(code, contains('// Component: AppButton'));
    });
    ...
    test('generates expected class documentation', () {
      ...
      expect(code, contains('/// A design-system-aware Button component.'));
    });
    ...
    test('generates valid Dart code (no syntax errors)', () {
      ...
      // ButtonGenerator produces multiple variant constructors
      expect(code.split('const AppButton').length,
          greaterThanOrEqualTo(2)); // At least default + 1 variant
