...
class ButtonGenerator implements ComponentGenerator {
  ...
  Iterable<Directive> _generateImports() {
    return [
      ...
      Directive.import(
          '../tokens/design_system.dart'), // Barrel: AppTheme, DesignStyle, styles
    ];
  }

  Class _generateButtonClass(MetaComponent component) {
    return Class(
      (b) => b
  ...
  Iterable<Constructor> _generateConstructors(MetaComponent component) {
    return [
      // Main constructor
      Constructor(
        (c) => c
